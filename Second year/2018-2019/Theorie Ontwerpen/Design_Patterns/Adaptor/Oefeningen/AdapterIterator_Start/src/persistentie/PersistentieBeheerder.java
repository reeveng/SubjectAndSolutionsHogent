...
public class PersistentieBeheerder {
    ...
    private void voegToeAanOuder(DefaultMutableTreeNode root,
        ...
        EnumerationIterator<TreeNode> e = new EnumerationIterator<TreeNode>(enumeration);
        int ouder = ((MenuActie) kind.getUserObject()).getOuder();
        //while (enumeration.hasMoreElements() && !gevonden) 
        while (e.hasNext() && !gevonden) {   //TODO gebruik adaptor  

            //DefaultMutableTreeNode node = enumeration.nextElement();
            DefaultMutableTreeNode node = (DefaultMutableTreeNode) e.next(); //TODO gebruik adaptor
