...
public class Class1 {
    ...
    public String toString() {
        ...
        IteratorEnumeration<String> e = new IteratorEnumeration<>(it);
        //while (it.hasNext())
        while (e.hasMoreElements()) //TODO gebruik adaptor
        {
            //builder.append(it.next()).append(" ");
            builder.append(e.nextElement()).append(" ");   //TODO gebruik adaptor
        }
